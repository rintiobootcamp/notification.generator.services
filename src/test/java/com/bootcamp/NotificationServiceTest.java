...
public class NotificationServiceTest {
    ...
    public void checkEvent() throws Exception {
        ...
        NotificationInput notification = notifications.get(1);

        PowerMockito.mockStatic(NotificationCRUD.class);
        Mockito.when(this.checkEventAndgenerateNotification(notification)).thenReturn(true);
    }
...
//        List<Notification> resultNotification = notificationService.findAll(mockRequest);
